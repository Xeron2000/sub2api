...
export const Route = createFileRoute("/admin/affiliates/invites")({
...
function InvitesPage() {
  ...
  const query = useQuery({
    queryKey: queryKeys.admin.affiliates.invites({ page, search: debounced }),
    queryFn: ({ signal }) => affiliatesAPI.listInvites({ page, page_size: pageSize, search: debounced || undefined }, { signal }),
  })
