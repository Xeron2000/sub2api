...
export const Route = createFileRoute("/admin/affiliates/rebates")({
  beforeLoad: createAdminGuard(),
  component: RebatesPage,
})
...
function RebatesPage() {
  ...
  const query = useQuery({
    queryKey: queryKeys.admin.affiliates.rebates({ page, search: debounced }),
    queryFn: ({ signal }) => affiliatesAPI.listRebates({ page, page_size: pageSize, search: debounced || undefined }, { signal }),
  })
