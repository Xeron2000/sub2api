...
export function LinuxDoCallbackPage() {
  ...
  return <Page><PageHeader title="LinuxDoCallback" description="OAuth callback — completing authentication." /><Section><LoadingState /></Section></Page>
}
