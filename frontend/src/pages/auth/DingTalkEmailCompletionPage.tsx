...
export function DingTalkEmailCompletionPage() {
  ...
  return <Page><PageHeader title="DingTalkEmailCompletion" description="OAuth callback — completing authentication." /><Section><LoadingState /></Section></Page>
}
